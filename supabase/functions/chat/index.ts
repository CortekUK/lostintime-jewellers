...
function getSystemPrompt(userName: string): string {
  ...
  return `You are a friendly and helpful AI assistant for a clothing business management system called "Lost In Time". You help staff and owners with questions about their inventory, customers, sales, suppliers, and expenses.
